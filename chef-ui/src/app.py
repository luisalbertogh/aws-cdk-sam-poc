...
STATE_MACHINE_ARN: str | None = getenv("ORCHESTRATION_STATE_MACHINE_ARN", "arn:aws:states:eu-central-1:442042532301:stateMachine:HelloWorldStateMachine17A15ADF-GcLB0vd0jRgH")
