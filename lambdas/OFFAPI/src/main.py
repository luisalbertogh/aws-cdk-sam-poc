...
class OpenFoodFactsAPI:
    PROD_URL = os.environ.get("OFF_PROD_URL", "https://es-es.openfoodfacts.org/cgi/search.pl")
    STAGING_URL = os.environ.get("OFF_STAGING_URL", "https://es-es.openfoodfacts.net/cgi/search.pl")
